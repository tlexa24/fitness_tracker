...
def get_program():
    ...
    to their desired program, and if they do not enter a valid choice, they will be prompted to try
    until their choice is valid
    :return: Returns the corresponding number to the selected program
    """
...
def get_routine():
    """
    This function reads in the available routines from the already chosen program from the
    SQL database, displaying these as choices to the user. The user will be prompted to
    enter the number that corresponds to their desired routine, and if they do not enter a
    valid choice, they will be prompted to try until their choice is valid
