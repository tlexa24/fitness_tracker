...
* Add functionality to store the next day's schedule in a text file rather than outputting to the terminal. 
...
* In general, revisit the logic of the scheduler. Maybe give schedule for the next week or so?
